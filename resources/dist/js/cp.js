...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    aspectRatio: function aspectRatio() {
      return "".concat(this.meta.height / this.meta.width * 100, "%");
    },
    socialImagesFields: function socialImagesFields() {
      return _.filter(this.$store.state.publish.base.values, function (value, key) {
        return key.includes('seo_social_images_');
      });
    }
  },
  watch: {
  ...
  methods: {
    ...
    resize: function resize() {
      ...
      this.$refs.iframe.contentDocument.body.style.transform = "scale(".concat(this.getContainerWidth() / this.meta.width, ")");
    },
...
var render = function () {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("element-container", { on: { resized: _vm.resize } }, [
    _c(
      "div",
      {
        ref: "container",
        staticClass: "relative w-full overflow-hidden",
        style: { "padding-top": _vm.aspectRatio },
      },
      [
        _c("iframe", {
          ref: "iframe",
          staticClass: "absolute inset-0 w-full h-full",
          attrs: { src: this.meta.url, frameborder: "0", scrolling: "no" },
        }),
      ]
    ),
  ])
              ...
              _c("div", { staticClass: "mt-1 help-block" }, [
                _vm.fieldSource === "auto"
                  ? _c("span", [
                      ...
                      _c("code", [
                        _vm._v(
                          _vm._s(_vm.autoFieldDisplay) +
                            " (" +
                            _vm._s(_vm.autoFieldHandle) +
                            ")"
                        ),
                      ]),
                      _vm._v(" field.\n                "),
                  ...
                  : _c("span", [
                      ...
                      _c("code", [_vm._v(_vm._s(this.meta.title))]),
                      _vm._v(" defaults.\n                "),
                    ]),
              ]),
            ],
